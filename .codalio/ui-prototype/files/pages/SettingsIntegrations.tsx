      ...
      window.parent.postMessage(
        {
          ...
          pageName: "SettingsIntegrations",
          prompt: `Please regenerate the page "SettingsIntegrations". The previous generation failed to produce code. Make sure to generate all sections for this page.`
        },
        "*"
      );
    }
      ...
      <div className="max-w-md w-full rounded-lg border border-border bg-card p-8 text-center shadow-sm space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground text-sm">
            The page "SettingsIntegrations" could not be generated. This may be due to an error during the generation process.
          </p>
        </div>
        <button
          type="button"
